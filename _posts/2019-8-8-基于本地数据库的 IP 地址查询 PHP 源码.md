---
layout: mypost
title: 基于本地数据库的 IP 地址查询 PHP 源码
categories: [php]
---
> 本文作者为[孟坤](https://mkblog.cn/1951/ "孟坤")

之前介绍过很多第三方的 IP 地址查询 API 接口，详见： [分享几个IP获取地理位置的API接口](https://mkblog.cn/481/ "分享几个IP获取地理位置的API接口")，直接调用第三方的接口很方便，但也容易失效导致无法使用。因此今天来分享一个基于本地数据库的 IP 地址查询源码！
#### 模块代码
```php
<?php
/**
...
```
#### 输出效果
![](https://mkblog.cn/wp-content/uploads/2019/07/20190707_005256_66.png)
#### 注意事项
...
[离线版点我](https://www.lanzous.com/i4vhiza "离线版点我")
